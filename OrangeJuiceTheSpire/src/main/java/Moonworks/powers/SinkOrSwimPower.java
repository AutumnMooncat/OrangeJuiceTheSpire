...
public class SinkOrSwimPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public SinkOrSwimPower(final AbstractCreature owner, final int amount) {
        name = NAME;
        ID = POWER_ID;
        ...
        this.loadRegion("like_water");//like_water energized_blue
    ...
    public AbstractPower makeCopy() {
        return new SinkOrSwimPower(owner, amount);
    }
}
